/*! webrexco 2016-08-27 version: 1.0.0*/
!
function(a) {
    var b = function(a) {};
    a.extend(b.prototype, {
        ...
        dateFormat: function(a, b) {
            ...
            isNaN(a) || "" == a ? "": a < 0 || a > 99999999999 ? "": new Date(1e3 * parseInt(a)).Format(b)
        },
        ...
        showPopupTips: function(b, c, d) {
            c = c || 3e3;
            var e = "";
            e += '<div class="m-popupTips"><div class="u-tips">',
            e += "<strong>" + b + "</strong>",
            e += "</div></div>",
            a("body").append(e),
            a("body>.m-popupTips").addClass("animation-fadeIn"),
            a("body>.m-popupTips").show();
            setTimeout(function() {
                a("body>.m-popupTips").addClass("animation-fadeOut"),
                setTimeout(function() {
                    a("body>.m-popupTips").remove()
                },
                500),
        ...
        tipsModal: function(a, b, c){
            if(a==1){
                var d="<div class='g-body-modal'>"
                        +"<div class='g-modal'>"
                            +"<div class='m-alertTop'>"
                                +"<p class=''>提示</p>"
                                +"<b class='u-modalClose'></b>"
                            +"</div>"
                            +"<p class='u-alertMes1'>"+b+"</p>"
                            +"<button type='button' class='u-alertSure'>确定</button>"
                        +"</div>"
                    +"</div>";
                $("body").prepend(d);
                if(c){
                ...
                var e="<div class='g-body-modal'>"
                        +"<div class='g-modal'>"
                            +"<div class='m-alertTop'>"
                                +"<p class=''>提示</p>"
                                +"<b class='u-modalClose'></b>"
                            +"</div>"
                            +"<p class='u-alertMes2'>"+b+"</p>"
                        +"</div>"
                    +"</div>";
                $("body").prepend(e);
                setTimeout(function(){$("body").remove("g-body-modal");},3000);
                if(c){
                    $(".u-modalClose").click(c);
                }
            }
